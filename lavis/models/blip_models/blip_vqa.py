...
class BlipVQA(BlipBase):
    ...
    def __init__(
        self, image_encoder, text_encoder, text_decoder, max_txt_len=35
    ):
        super().__init__()
    ...
    def predict_answers(
        ...
        **kwargs
        ...
        if inference_method == "generate":
            ...
            assert (
                answer_list is not None
            ), "answer_list must be provided for ranking"
    ...
    def _generate_answers(
        self, samples, num_beams=3, max_length=10, min_length=1
    ):
