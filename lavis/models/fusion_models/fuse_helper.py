...
class BiMultiHeadAttention(nn.Module):
    def __init__(
        ...
        self.stable_softmax_2d = (
            False  # cfg.MODEL.DYHEAD.FUSE_CONFIG.STABLE_SOFTMAX_2D # False
        )
        self.clamp_min_for_underflow = (
            True  # cfg.MODEL.DYHEAD.FUSE_CONFIG.CLAMP_MIN_FOR_UNDERFLOW # True
        )
        self.clamp_max_for_overflow = (
            True  # cfg.MODEL.DYHEAD.FUSE_CONFIG.CLAMP_MAX_FOR_OVERFLOW # True
        )
